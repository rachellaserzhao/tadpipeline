...
const char* HomerConfig::homeDirectory = "/home/rachelz/pipeline/tadpipeline/homer/./";
		...
		if (gil != NULL && actionFlag & HIC_MASK_INTERACTIONSTATSFILES) {
			...
			for (int i=0;i<count;i++) {
				if (strcmp(curPETags[i]->chr2,chr1)==0) {
					if (fabs((double)(curPETags[i]->p1-curPETags[i]->p2)) > (double)(2*fragmentLengthEstimate) 
					 			&& fabs((double)(curPETags[i]->p1-curPETags[i]->p2)) < 5000) {
